...
if st.button("Run Connection Test"):
    ...
    try:
        ...
        if "Access Denied" in page_title or "403" in page_title:
            ...
            st.info("Since connection is OK, the N/A problem is likely due to the site's anti-bot detection during data extraction.")
        else:
            st.warning(f"⚠️ Result: Unknown response. Title received: {page_title}")
